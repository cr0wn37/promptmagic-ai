  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      toast({
        ...
        description: "Welcome back to MicroPrompt AI.",
        variant: "default",
      });
      router.push('/dashboard');
    }
        ...
        <div className="w-full md:w-1/2 flex items-center justify-center p-6 sm:p-8 lg:p-10 text-gray-900">
          <div className="w-full max-w-xs space-y-6 animate-fade-in-up">
            <div className="text-center md:text-left">
              <h1 className="text-3xl font-extrabold text-gray-900 mb-2">Hello!</h1>
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <Link href="/auth/forgot-password" className="block text-right text-sm text-mint-palette-600 hover:underline font-medium">
                Forgot Password?
              </Link>
            ...
            <div className="text-center text-sm text-gray-600">
              ...
              <Link href="/auth/signup" className="text-mint-palette-600 hover:underline font-medium">
                Sign Up
              </Link>
            </div>
          </div>
