...
export const metadata = {
  title: 'Sales Prompts | MicroPrompt AI',
  description: 'AI-powered Sales prompt workflows.',
};
...
export default async function SalesPage() {
  ...
  return (
    <div className="p-6">
      ...
      💼 Sales Prompt Workspace
      </h1>
      <p className="text-mint-palette-600 dark:text-mint-palette-300 mb-8">
        Select a pre-defined Sales prompt and generate tailored AI responses.
      </p>

      
      <CategoryPromptRunner category="Sales" />
    </div>
  );
}
