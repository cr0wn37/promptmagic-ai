...
export const metadata = {
  title: 'HR Prompts | MicroPrompt AI', // Update title
  description: 'AI-powered HR prompt workflows.', // Update description
};

export default async function HRPage() { // Update function name
